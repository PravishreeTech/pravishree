        ...
        <div className="contact-hero-container">
          ...
          <div className="contact-page-header">
            ...
            <div className="contact-social-row gsap-hero-anim">
              <a href="https://www.linkedin.com/company/pravishree/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="contact-social-btn" title="LinkedIn" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                <span className="social-lbl">LinkedIn</span>
              </a>
              <a href="https://www.instagram.com/pravishreedesignco/" target="_blank" rel="noopener noreferrer" className="contact-social-btn" title="Instagram" aria-label="Instagram">
              ...
              <a href="mailto:pravishreedesignco@gmail.com" target="_blank" rel="noopener noreferrer" className="contact-social-btn" title="Email Us Direct" aria-label="Email Us Direct">
                <Mail size={18} />
          ...
          <div className="contact-three-cards-grid">
            ...
            <div className="bottom-info-card glass-card card-address-card">
              ...
              <address className="info-card-full-address">
                <span className="address-blue-line">Amma Apartments, CBM Compound</span>
                <span className="address-navy-line">Visakhapatnam</span>
                <span className="address-navy-line">Andhra Pradesh - 530003</span>
              </address>
            </div>
